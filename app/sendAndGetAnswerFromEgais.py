...
def send_request_with_captcha(ttn, fsrar, captcha_id, code_captcha, session) -> str:
    ...
    response = session.post(DATA_FOR_THE_REQUEST['url'], data=TextRequest, headers=headers)
